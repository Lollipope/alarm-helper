import { AlarmHistoryParams, ResponseResult, AlarmMsg, PageList, AlarmSmallType, AlarmUserConf, UnreadBean, AlarmBigType, SortAlarmBigType, AlarmConfigMsgUser, StreamPlayApiParams, StreamStopApiParams, ConfigMsgKindListApiParams } from './types';
export declare function getAlarmMsgPage(params: AlarmHistoryParams): Promise<ResponseResult<PageList<AlarmMsg>>>;
export declare function getAlarmConfigListByKindId(alarmKindId: number | string): Promise<ResponseResult<Array<AlarmSmallType>>>;
export declare function getAlarmConfigListByKindIdWithEnable(alarmKindId: number | string): Promise<ResponseResult<Array<AlarmSmallType>>>;
...
export declare function getConfigMsgKindList(params: ConfigMsgKindListApiParams): Promise<ResponseResult<Array<AlarmBigType>>>;
...
export declare const getAlarmConfigMsgUserPage: () => Promise<unknown>;
