<template>
        ...
        <el-table :data="tableData" style="width: 100%;height: 100%;" empty-text="暂无历史记录">
            ...
            <el-table-column align="center" prop="test" label="发送内容">
                <template #default="scope">
                    <div @click="browseShow = true,content = scope.row.content" class="browse">浏览</div>
                </template>
            </el-table-column>
    ...
    <BrowseDialog :alarmSelect="alarmSelect" :content="content" v-model:visible="browseShow"></BrowseDialog>
</template>
