  ...
  <div class="alarm-detail">
    ...
    <div class="detail" v-if="alarmSelect && alarmSelect.msgId && isNew">
      ...
      <div class="other-box">
        ...
        <!-- 视频抓拍 -->
        <PicCapture :alarmSelect="alarmDetialInfo" v-if="PermConf.pic.perm" />
        <noImg v-else :head-type="'视频抓拍'"></noImg>
        <!-- 录像回放 -->
        <RecordPlay :alarmSelect="alarmDetialInfo" v-if="PermConf.record.perm" />
        <noImg v-else :head-type="'录像回放'"></noImg>
        <!-- 视频实况 -->
        <LivePlay :alarmSelect="alarmDetialInfo" v-if="PermConf.live.perm" />
